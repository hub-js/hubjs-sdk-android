...
public class EventDiskCache {
    private static final String TAG = Hubjs.tag(EventDiskCache.class);
    private static final String CACHE_DIR_NAME = "hubjs_cache";
    ...
    public EventDiskCache(Tracker tracker) {
        ...
        File baseDir = new File(tracker.getHubjs().getContext().getCacheDir(), CACHE_DIR_NAME);
        try {
