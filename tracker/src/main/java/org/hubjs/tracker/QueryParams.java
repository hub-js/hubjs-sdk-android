...
public enum QueryParams {
     ...
     * To access this value, users must be logged-in in your system so you can fetch this user ID from your system, and pass it to Hubjs.
     ...
     * Note: if you record data in the past, you will need to force Hubjs to re-process reports for the past dates.
     */
    ...
    // Other parameters
    /**
     * If set to 0 (send_image=0) Hubjs will respond with a HTTP 204 response code instead of a GIF image.<p>
     * This improves performance and can fix errors if images are not allowed to be obtained directly (eg Chrome Apps). Available since Hubjs 2.10.0
     */
