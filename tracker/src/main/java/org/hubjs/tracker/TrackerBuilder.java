...
public class TrackerBuilder {
    ...
    /**
     * @param apiUrl      Tracking HTTP API endpoint
    ...
    /**
     * Domain used to build the required parameter url 
    ...
    public Tracker build(Hubjs hubjs) {
        if (mApplicationBaseUrl == null) {
            mApplicationBaseUrl = String.format("https://%s/", hubjs.getContext().getPackageName());
        }
        return new Tracker(hubjs, this);
    }
