...
import org.hubjs.tracker.QueryParams;
import org.hubjs.tracker.TrackMe;
import org.hubjs.tracker.Tracker;
import org.hubjs.tracker.tools.ActivityHelper;
import org.hubjs.tracker.tools.CurrencyFormatter;
...
public class TrackHelper {
    private static final String TAG = Hubjs.tag(TrackHelper.class);
    ...
    static abstract class BaseEvent {
        ...
        public void with(HubjsApplication hubjsApplication) {
            with(hubjsApplication.getTracker());
        }
        ...
        public boolean safelyWith(HubjsApplication hubjsApplication) {
            return safelyWith(hubjsApplication.getTracker());
        }
    ...
    public static class Screen extends BaseEvent {
         ...
         *
         * @see org.hubjs.tracker.extra.CustomDimension and {@link #dimension(int, String)}
    ...
    /**
     * By default, Goals in Hubjs are defined as "matching" parts of the screen path or screen title.
     ...
     *
     * @param idGoal id of goal as defined in hubjs goal settings
     */
     ...
     * Case {@link org.hubjs.tracker.extra.DownloadTracker.Extra.ApkChecksum}:<br>
     * http://packageName:versionCode/apk-md5-checksum<br>
     * <p>
     * Case {@link org.hubjs.tracker.extra.DownloadTracker.Extra.None}:<br>
    ...
    public static class Download {
         ...
         *
         * @param identifier {@link org.hubjs.tracker.extra.DownloadTracker.Extra.ApkChecksum} or {@link org.hubjs.tracker.extra.DownloadTracker.Extra.None}
         * @return this object, to chain calls.
         */
     ...
     * Keep in mind Hubjs is not a crash tracker, use this sparingly.
     * <p>
     ...
     * This would mean the same exception (event) is tracked as different events by Hubjs.
     *
    ...
    public static class UncaughtExceptions {
        ...
        public Thread.UncaughtExceptionHandler with(Tracker tracker) {
            if (Thread.getDefaultUncaughtExceptionHandler() instanceof HubjsExceptionHandler) {
                throw new RuntimeException("Trying to wrap an existing HubjsExceptionHandler.");
            }
            Thread.UncaughtExceptionHandler handler = new HubjsExceptionHandler(tracker, mBaseBuilder.mBaseTrackMe);
