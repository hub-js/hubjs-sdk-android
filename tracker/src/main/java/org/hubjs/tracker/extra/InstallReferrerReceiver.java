...
public class InstallReferrerReceiver extends BroadcastReceiver {
    private static final String TAG = Hubjs.tag(InstallReferrerReceiver.class);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(REFERRER_SOURCE_GPLAY)) {
            ...
            if (referrer != null) {
                ...
                new Thread(() -> {
                    Hubjs.getInstance(context.getApplicationContext()).getPreferences().edit().putString(PREF_KEY_INSTALL_REFERRER_EXTRAS, referrer).apply();
